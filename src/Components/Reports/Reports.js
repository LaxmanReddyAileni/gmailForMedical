...
// import file from "../../Data/11-0.txt";
  ...
  componentDidUpdate(prevProps) {
    if (this.props.searchResults !== prevProps.searchResults) {
      this.setState({
        ...
        5: this.props.searchResults.slice(60, 79),
        currentPage: 1,
      });
    }
  }
            ...
            <tbody>
              {this.state[this.state.currentPage].map((data) => (
                <tr onClick={() => this.props.onClick(data)}>
                  ...
                  <td>
                    {this.props.tags.goodreport.includes(data.id)
                      ? "goodreport"
                      : null}
                    {this.props.tags.conditionpresent.includes(data.id)
                      ? "conditionpresent"
                      : null}
                  </td>
                </tr>
            ...
            <ul className="pagination justify-content-center">
              ...
              >
                <a
                  className="page-link"
                  aria-label="Previous"
                  onClick={() => this.paginationPrev(this.state.currentPage)}
                >
                  <span aria-hidden="true">&laquo;</span>
                </a>
              </li>
              <li className="page-item">
                <a className="page-link" onClick={() => this.pagination(1)}>
                  1
                </a>
              </li>
              {this.props.searchResults.length > 20 ? (
                <li className="page-item">
                  <a className="page-link" onClick={() => this.pagination(2)}>
                    2
                  </a>
                </li>
              ) : null}
              {this.props.searchResults.length > 40 ? (
                <li className="page-item">
                  <a className="page-link" onClick={() => this.pagination(3)}>
                    3
                  </a>
                </li>
              ) : null}
              {this.props.searchResults.length > 60 ? (
                <li className="page-item">
                  <a className="page-link" onClick={() => this.pagination(4)}>
                    4
                  </a>
                </li>
              ) : null}
              <li
                className={
                  this.state[this.state.currentPage + 1].length > 0
                    ? "page-item"
                    : "page-item disabled"
                }
              >
                <a
                  className="page-link"
                  aria-label="Next"
                  onClick={() => this.paginationNext(this.state.currentPage)}
                >
          ...
          <div style={{ color: "white" }}>
            {this.props.tags.goodreport.includes(this.props.idToPass) ? (
              <button
                ...
                onClick={() =>
                  this.props.removeTag("goodreport", this.props.idToPass)
                }
              >
                {" "}
              ...
              <button
                ...
                style={{ marginRight: "10px" }}
                onClick={() =>
                  this.props.addTag("goodreport", this.props.idToPass)
                }
              >
                {" "}
                <i className="far fa-smile"></i> + goodreport{" "}
              </button>
            )}
            ...
            {this.props.tags.conditionpresent.includes(this.props.idToPass) ? (
              <button
                ...
                className="btn btn-danger"
                onClick={() =>
                  this.props.removeTag("conditionpresent", this.props.idToPass)
                }
              >
                {" "}
              ...
              <button
                ...
                className="btn btn-success "
                onClick={() =>
                  this.props.addTag("conditionpresent", this.props.idToPass)
                }
              >
                {" "}
                <i className="far fa-frown"></i> + conditionpresent{" "}
            ...
            <iframe
              ...
              width="100%"
              height="800px"
              src={`${DATA[this.props.idToPass].url}`}
            ></iframe>
          </div>
        ) : null}
      </div>
